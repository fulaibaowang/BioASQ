...
# Paths / inputs
# -----------------------------
MAIN_CONTAINER="/shared/home/yun.wang/biolab/yun/bioasq_08.03.26b200.sqfs"
LISTWISE_CONTAINER="/shared/home/yun.wang/biolab/yun/bioasqlistwisereranker_16.03.26v3b200.sqfs"
WORKDIR="${PWD}"
PUBMED_HOST="/shared/workspace/biolab/pubmed"

# Pipeline config (must have RUN_SNIPPET_RRF=1 or use --run-both-routes)
PIPELINE_CONFIG="scripts/private_scripts/hpc/bioasq_runs/config_gemma_b200.env"
