...
# Pipeline config
PIPELINE_CONFIG="scripts/private_scripts/hpc/config_10pct_sbatch_test.env"
...
srun \
  ...
  bash -lc "
    ...
    # --- Optional: shared HF cache on /pubmed ---
    ...
    echo \"[run] Starting retrieval + rerank pipeline\"
